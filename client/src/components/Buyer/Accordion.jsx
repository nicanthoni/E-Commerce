        ...
        <AccordionDetails>
          <Typography variant="caption">
            <List>
              ...
              <ListItem>Name: {user.firstName} {user.lastName}</ListItem>
...
{/* WISHLIST - Once items have image data, the accordion will be a horizontal scroll of imgs*/}
      <Accordion>
        ...
        <Typography variant="caption">There are 0 items in your wishlist.</Typography>
      )}
        </AccordionDetails>
      </Accordion>
...
{/* CART - will be just IMGs + total price */}
      <Accordion>
        ...
        <Typography variant="caption">There are 0 items in your cart.</Typography>
      )}
        </AccordionDetails>
      </Accordion>
...
{/*   ORDER HISTORY - Name + Price + Date */}
      <Accordion>
        ...
        <Typography variant="caption">There have been 0 orders placed from this account.</Typography>
      )}
        </AccordionDetails>
      </Accordion>
...
{/*   REVIEW HISTORY - Name + Stars + Review + Date */}
      <Accordion>
        ...
        <Typography variant="caption">There have been 0 reviews left from this account.</Typography>
      )}
        </AccordionDetails>
      </Accordion>
    </Box>
